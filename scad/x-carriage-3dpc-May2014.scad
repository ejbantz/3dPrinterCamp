                                    ...
                                    linear_extrude(height = rim_thickness, center = true, convexity = 5)
                                        difference() {
                                            ...
                                            translate([-base_offset, -hole_offset])
                                                rounded_square(hole + 4 * wall, hole_width + 2 * wall, corner_radius + wall);
...
hull()
{
	cylinder(h = 4,r = 13,center = false);
	translate([-1,20,0]) cylinder(h = 4,r = 5,center = false);
}
}
...
hull()
{
	cylinder(h = 30,r = 11,center = true);
	translate([-1,20,0]) cylinder(h = 30,r = 3,center = true);
}
}